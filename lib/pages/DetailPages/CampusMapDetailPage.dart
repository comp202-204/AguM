  ...
  class Building {
    ...
    factory Building.fromJson(Map<String, dynamic> json) {
      return Building(
          ...
          buildingId: int.parse(json['buildingId'].toString()), // Assuming building_id is received correctly as an integer, converting it to string if needed
      );
    }
  }
  ...
  class _DynamicPageState extends State<DynamicPage> {
    ...
    Future<void> fetchClassName() async {
      ...
      final response = await http.get(Uri.parse('http://192.168.56.1/localconnect/DynamicPageClassNames.php?buildingId=${widget.buildingId}&classId=${widget.classId}'));
