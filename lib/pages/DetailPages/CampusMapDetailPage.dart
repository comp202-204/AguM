...
class _CampusMapDetailPageState extends State<CampusMapDetailPage> {
  ...
  Future<List<Building>> fetchBuildings() async {
    final response = await http.get(Uri.parse('http://192.168.1.107/localconnect/classNumber_BuildingsInfo.php'));
...
class _CommentPageState extends State<CommentPage> {
  ...
  Future<void> getComments() async {
    ...
    final response = await http.get(Uri.parse('http://192.168.1.107/localconnect/GetComments.php?buildingId=${widget.buildingId}&classId=${widget.classId}'));
  ...
  Future<void> addComment(String newComment) async {
    final response = await http.post(
      Uri.parse('http://192.168.1.107/localconnect/AddComment.php'),
      body: {
...
class _DynamicPageofReservationState extends State<DynamicPageofReservation> {
  ...
  Future<List<Map<String, dynamic>>> fetchUnavailableClassData() async {
    final response = await http.get(Uri.parse('http://192.168.1.107/localconnect/GetClassStatus.php?classId=${widget.classId}'));
    if (response.statusCode == 200) {
      List<dynamic> data = jsonDecode(response.body);
